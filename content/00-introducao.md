...
- Um navegador web atualizado (Chrome, Edge ou Firefox).
- Uma webcam no computador e um smartphone para testar os projetos.
...
5. Projetar ilustrações 2D no mundo real e animá-las nativamente.
